package com.oj.company.alibaba.myself.test2;
...
//                System.out.println("i = " + i + " j = " + j + " " + Arrays.toString(Arrays.copyOfRange(serial, i, j)));
                res.add(Arrays.copyOfRange(serial, i, j));
            }
        }
        return res;
    }
